...
class VehicleServiceImplTest {
    ...
    void shouldRegisterVehicleSuccessfully() {
        when(repo.existsByLicensePlate("MP04AB1234")).thenReturn(false);

        when(mapper.toEntity(any(VehicleRequestDTO.class), eq("sanvi@test.com")))
                .thenReturn(vehicle);
        when(repo.save(vehicle)).thenReturn(vehicle);
        when(mapper.toDTO(vehicle)).thenReturn(responseDTO);

        VehicleResponseDTO result =
                service.registerVehicle(requestDTO, "sanvi@test.com");
    ...
    void shouldThrowWhenDuplicateVehiclePlateExists() {
        when(repo.existsByLicensePlate("MP04AB1234")).thenReturn(true);
    ...
    void shouldUpdateVehicleSuccessfully() {
        ...
        VehicleResponseDTO result =
                service.updateVehicle(1L, requestDTO, "sanvi@test.com");
    ...
    void shouldDeleteVehicleSuccessfully() {
        ...
        service.deleteVehicle(1L, "sanvi@test.com");
    ...
    void shouldDeactivateVehicleSuccessfully() {
        ...
        service.deactivateVehicle(1L, "sanvi@test.com");
    ...
    void shouldGetMyVehiclesSuccessfully() {
        when(repo.findByOwnerEmailAndIsActiveTrue("sanvi@test.com"))
                .thenReturn(List.of(vehicle));
        when(mapper.toDTO(vehicle)).thenReturn(responseDTO);

        List<VehicleResponseDTO> result =
                service.getMyVehicles("sanvi@test.com");

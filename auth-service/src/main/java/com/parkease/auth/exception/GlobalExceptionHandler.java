...
public class GlobalExceptionHandler {
    ...
    public ApiResponse handleLocked(LockedException ex) {
        log.warn("Suspended user login attempt: {}", ex.getMessage());
        return ApiResponse.fail("Your account has been suspended by the admin.");
    }
    ...
    public ApiResponse handleGeneral(HttpServletRequest request, Exception ex) throws Exception {
        ...
        return ApiResponse.fail("Unexpected error: " + ex.getMessage());
    }
}

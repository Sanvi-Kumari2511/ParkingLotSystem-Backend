...
public class AuthController {
     ...
     * PUT /api/auth/me
     * Header: Authorization: Bearer <access_token>
     * Body: { "fullName": "John", "email": "john@example.com", "currentPassword": "...", "newPassword": "..." }
    ...
    public ResponseEntity<UserResponse> updateProfile(
        ...
        log.info("PUT /api/auth/me - user: {}", userDetails.getUsername());
        UserResponse updatedProfile = authService.updateProfile(userDetails.getUsername(), request);

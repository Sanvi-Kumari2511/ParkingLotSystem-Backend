...
class EmailServiceTest {
    ...
    void shouldSendPasswordResetEmailSuccessfully() {
        emailService.sendPasswordResetEmail("sanvi@test.com", "token123");
        ...
        assertEquals("sanvi@test.com", message.getTo()[0]);
    ...
    void shouldSendWelcomeEmailSuccessfully() {
        emailService.sendWelcomeEmail("sanvi@test.com", "Sanvi");
        ...
        assertTrue(message.getText().contains("Hi Sanvi"));

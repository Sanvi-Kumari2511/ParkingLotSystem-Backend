...
public interface BookingService {
     ...
     *   RESERVED_AVAILABLE→ Has a future pre-booking, but drive-in can use it
     *                        until that reservation's startTime.
     *                        Label: "Available until HH:mm".
     *   OCCUPIED          → Currently occupied; NOT selectable.
     *   MAINTENANCE       → Under maintenance; NOT selectable.
     *
     * @param lotId Lot to query
    ...
    /** Forced checkout by manager/admin. */
    BookingResponseDTO manualCheckOut(Long bookingId, String performerEmail);
}
